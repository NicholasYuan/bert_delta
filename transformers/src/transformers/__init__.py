...
if is_torch_available():
    ...
    # new add 
    from .modeling_bert_delta import (
        BertPreTrainedModel_delta,
        BertModel_delta,
        BertForPreTraining_delta,
        BertForMaskedLM_delta,
        BertForNextSentencePrediction_delta,
        BertForSequenceClassification_delta,
        BertForMultipleChoice_delta,
        BertForTokenClassification_delta,
